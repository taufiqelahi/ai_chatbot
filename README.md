      ...
      body: Stack(
        children: [
          ...
          SmartChatBotHelper(
            ...
            appDescription:
                "A professional app with chat, meetings, and news features.",

            predefinedButtons: {
              "How to create a meeting?":
                  "Go to Meetings tab and click Create Meeting.",
              "How to contact support?":
                  "Use the Support tab in the app.",
            },
...
token:
"Your OpenRouter API Key Here (Get it from https://openrouter.ai)",
),
```
